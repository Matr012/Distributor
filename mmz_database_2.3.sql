...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 14. 09:44
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `username`, `email`, `phone`, `card_type_id`, `password_hash`, `profile_pic`, `is_artist`, `verified`, `permission`, `created_at`, `updated_at`) VALUES
(1, 'admin1', 'admin2', 'admin', 'admin@gmail.com', '+36123456789', 3, '', '\'https://...default.jpg/', 1, 1, 2, '2026-01-12 10:52:24', '2026-01-12 10:52:24');
...
--
ALTER TABLE `user_subscriptions`
  ADD CONSTRAINT `fk_sub_plan` FOREIGN KEY (`plan_id`) REFERENCES `subscription_plans` (`id`) ON DELETE CASCADE,
