...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      console.log('✅ Login successful, hasSubscription:', result.hasSubscription);
      
      // Ha van előfizetése VAGY admin → főoldal, ha nincs → subscription oldal  
      const targetPath = result.hasSubscription ? '/' : '/subscription';
      console.log('📍 Redirect path:', targetPath);
